  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-6xl mx-auto w-full px-6 py-10">
        ...
        <form onSubmit={handleGenerate} className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 mb-8">
          {error && (
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm text-neutral-400 mb-1">Senha admin</label>
              <input
                type="password"
                required
                value={secret}
            ...
            <div>
              <label className="block text-sm text-neutral-400 mb-1">Nicho</label>
              <input
                type="text"
                required
                list="nicho-list"
          ...
          <details className="mt-4">
            <summary className="text-sm text-rose-400 cursor-pointer select-none">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-neutral-800 border border-neutral-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-rose-500 transition-colors"
                >
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-4 bg-rose-600 hover:bg-rose-500 disabled:opacity-50 transition-colors px-6 py-2.5 rounded-xl font-medium flex items-center gap-2"
          >
            {loading ? (
              <>
        ...
        {result && (
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                onClick={copyAll}
                className="bg-neutral-800 hover:bg-neutral-700 transition-colors px-4 py-2 rounded-lg text-sm font-medium"
              >
                Copiar tudo
              </button>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
              {result.days.map((day) => (
                <div
                  key={day.day}
                  className="bg-neutral-900 border border-neutral-800 hover:border-rose-700/30 transition-colors rounded-xl p-3 group cursor-default"
                >
